...
- Treat both sources as joint constraints:
  - data dataset technical guidance.
  - Sex-differences commentary on hypothesis-driven interaction inference.
- Keep data inference explicitly observational.
...
- Keep non-binary groups explicit when present; do not collapse by default.

## Terminology Rules
- Do not conflate sex and gender in prose or output labels.
- Use consistent sex-category labels in prose and outputs.
